...
&& wget -P /usr/local/java/ "http://mirrors.hust.edu.cn/apache/tomcat/tomcat-8/v8.0.36/bin/apache-tomcat-8.0.36.tar.gz" \
&& wget -P /usr/local/java/ "https://www.openssl.org/source/openssl-1.0.2h.tar.gz" \
&& wget -P /usr/local/java/ "http://mirrors.hust.edu.cn/apache/tomcat/tomcat-connectors/native/1.2.8/source/tomcat-native-1.2.8-src.tar.gz" \
&& wget -P /usr/local/java/ "http://mirrors.hust.edu.cn/apache/apr/apr-1.5.2.tar.gz" \
&& wget -P /usr/local/java/ "http://mirrors.hust.edu.cn/apache/apr/apr-util-1.5.4.tar.gz"
