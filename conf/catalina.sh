...
JAVA_OPTS="-server -Dfile.encoding=UTF-8 -Duser.timezone=GMT+08 -Xms256m -Xmx512m -Dspring.profiles.active=test -Djava.library.path=/usr/local/java/apache-tomcat-8.5.4/lib"
